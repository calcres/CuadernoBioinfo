---
title: "Práctica 2: Control de versiones con Git"
lang: es
date: today
execute: 
  eval: true
...
```
- Nuestro repositorio tiene el nombre de tronco. Trabajamos con unos archivos que se
 van a unificar a lo largo del tiempo. Un commit es un momento en la historia de 
nuestra carpeta etiquetada con una larga frase con números y letras. Representamos los commits como cajitas etiquetadas con estas cadenas. Si vamos modificando archivos y vamos pasando de una a otra vamos creando una historia de commits. HEAD es como un puntero que señala la versión actual. Este puntero lo podemos mover, por ejemplo a una versión anterior. Así, todos los archivos de la carpeta se modificarían a la versión anterior. Git nos salva de tener muchos archivos con distintos nombres porque git ya nos guarda las versiones anteriores sin necesidad de tener nombres distintos. 
- La rama es una forma de identificar ese camino que han seguido las carpetas. 
¿Cómo se ramifica? Se puede crear una rama x ej escribiendo el guion de prácticas en 
verso. Podemos tener en paralelo dos ramas, decidiendo si continuo trabajando con el 
documento en verso o en prosa. Al final, podemos decidir si destruimos uno de los 2 
archivos. Esto también sirve para modificar archivos o programas que funcionan bien 
para tratar de mejorarlos sin comprometer versiones actuales que van bien. Para saber 
cuántas ramas tenemos: git branch -a   
(La activa aparecerá con el asterisco). 
